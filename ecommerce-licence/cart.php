    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <?php
            ...
            if($result){
              ...
              while($obj = $result->fetch_object()) {
                ...
                $total = $total + $cost; //add to the total cost
                   $prdnam=$obj->product_code;
                   $prcos=$obj->product_name;
                echo '<tr>';
          ...
          if(isset($_SESSION['username'])) {
            echo '<a href="PayPal.php?id='.$id.'&produit='.$prcos.'&ammount='.$total.'"><button style="float:right;">COD</button></a>';
          }
...
<br>
       ...
       <br>
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; MyHome Shop.</p>
        </footer>
