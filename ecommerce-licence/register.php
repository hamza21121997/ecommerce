  ...
  <body>
        ...
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Prenom" name="fname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Nom" name="lname">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Adresse" name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="Casablaca" name="city">
            </div>
          </div>
          <div class="row">
           <!-- <div class="small-4 columns">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="Xy@gmail.com" name="email">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer>
           <p style="text-align:center; font-size:0.8em;">&copy; MyHome online Shop.</p>
        </footer>
